    ...
    return (
        <main className="bg-teal-50">
            <div className="container min-h-screen mx-auto flex">
                <aside className="bg-white rounded-lg p-4 m-4 md:w-72 flex-shrink-0"></aside>
                <section className="m-4 md:ml-2 flex-grow">
                    <div
                        className="rounded-lg h-48 p-4 bg-repeat bg-center text-white"
                        style={{
                    ...
                    >
                        <h2 className="text-bold text-3xl">Hi, Suheel</h2>
