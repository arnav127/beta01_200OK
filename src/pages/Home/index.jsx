            ...
            <div className="container px-3 pt-3 mx-auto">
                ...
                <div className="flex flex-col flex-wrap items-center py-16 md:flex-row">
                    <div className="flex flex-col justify-center items-start w-full text-center text-white md:w-2/5 md:text-left">
                        ...
                        <button className="py-4 px-8 my-4 mx-auto font-bold text-gray-800 bg-white rounded-full shadow-lg transition duration-300 ease-in-out transform lg:mx-0 hover:underline hover:scale-105 focus:outline-none focus:shadow-outline">
                            Subscribe
                        </button>
                    </div>
                </div>
